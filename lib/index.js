...
var _default = function _default(_ref) {
  ...
  var s = {
    ...
    success: _chalk["default"].keyword('greenBright').bold,
    info: _chalk["default"].keyword('cyan').bold,
  ...
  var e = {
    success: _nodeEmoji["default"].get('heavy_check_mark'),
    error: _nodeEmoji["default"].get('x'),
    info: _nodeEmoji["default"].get('grey_exclamation'),
    warning: _nodeEmoji["default"].get('warning'),
    waiting: _nodeEmoji["default"].get('hourglass')
  };
  ...
  console.log("".concat(timeStyle(time)).concat(emojiToDisplay, " ").concat(globalStyle(name)).concat(modeStyle(mode)).concat(globalStyle(value)));
};
